...
import {useSidebar} from "vitepress-carbon";
import {VPDocAside, VPDocFooter, VPDocFooterLastUpdated} from "vitepress-carbon/components";
        ...
        <div class="content-container">
          ...
          <main class="main">
            <div class="vp-doc"
              ...
              <ul>
                <li v-for="(source, index) in page.frontmatter.sources" :key="index">
